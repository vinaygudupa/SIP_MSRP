...
IMAGE_NAME = file_lines[12].split('=')[1].strip()
...
image_file_len = len(image_data)
msrp_data_part = '<?xml version="1.0" encoding="UTF-8"?><file xmlns="urn:gsma:params:xml:ns:rcs:rcs:fthttp"><file-info type="file"><file-size>' + str(image_file_len) + '</file-size><file-name>img_' + str(randint(00000000,99999999)) + '_183610_small_1413810372748.jpg</file-name><content-type>image/jpeg</content-type><data url="http://172.24.3.230:9999/mStoreRoot/file/' + str(randint(00000000,99999999)) + 'B7ACE9D1A312444FF6FDA0A6E1C1DC6E1FBF1FC5F49C719050ECC2BA" until="2017-08-15T14:48:48.000Z"/></file-info></file>'
